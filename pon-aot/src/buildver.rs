...
///
/// Cranelift-object may already set this for versioned Apple triples. This helper
/// deliberately overwrites it with Pon's Phase C floor so version-less host triples
/// still avoid Xcode's "no platform load command" warning.

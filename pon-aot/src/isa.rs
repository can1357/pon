...
/// architectures where Cranelift supports the strategy used by the Phase C plan.
#[must_use]
...
fn supports_inline_probestack(triple: &Triple) -> bool {
    matches!(
        triple.architecture,
        Architecture::Aarch64(_) | Architecture::X86_64 | Architecture::X86_64h | Architecture::Riscv64(_)
    )
}

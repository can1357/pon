...
//!
//! Baseline emits direct helper calls for the pattern predicates/extractors
//! that have runtime bodies. Returned boxed truth values and extract carriers
//! preserve the shared NULL-sentinel error contract.
...
pub(crate) fn lower_match_len_ge(
	...
	let exact = builder
		.ins()
		.iconst(ir::types::I8, i64::from(u8::from(exact)));

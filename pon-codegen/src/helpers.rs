...
//! frozen signature table; imports are declared from the runtime table so
//! codegen cannot drift from real exported symbols.

use cranelift_codegen::ir::{self, AbiParam};
use cranelift_module::{FuncId, Linkage, Module, ModuleResult};
use pon_runtime::abi::{AbiTy, HELPERS};

/// Cranelift module function ids for every runtime helper import codegen may
/// call.
///
...
/// Consumers pass these ids to baseline lowering, which then imports
/// per-function [`cranelift_codegen::ir::FuncRef`] handles with
...
pub struct HelperRefs {
	...
	pub call:                  FuncId,
	/// `pon_call_ex(callee, argv, argc, star, kw_names, kw_values, kw_count,
	/// dstar, feedback) -> *mut PyObject`.
	pub call_ex:               FuncId,
	...
	/// `pon_make_function_full(code_info, defaults, default_count,
	/// kwdefault_names, kwdefaults, kwdefault_count, annotation_names,
	/// annotations, annotation_count) -> *mut PyObject`.
	...
	/// `pon_build_class_ex(body, name_id, bases, base_count, kw_names,
	/// kw_values, kw_count) -> *mut PyObject`.
	pub build_class:           FuncId,
	/// `pon_build_class_full(body, name_id, bases_seq, kw_names, kw_values,
	/// kw_count, dstar) -> *mut PyObject`.
...
///
/// `feedback_trailing` counts how many entries at the end of [`Self::params`]
/// are feedback/profiling cells.  The table is intentionally descriptive until
/// each runtime body exists; Phase-A codegen must keep using
/// [`declare_helpers`] so it imports only the implemented helpers it calls.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct HelperSig {
	...
	/// Future C symbol name, or the current Phase-A symbol when already
	/// exported.
...
const P_OBJ_ARR_FEEDBACK: &[AbiShape] =
	&[AbiShape::PyObjectPtrPtr, AbiShape::Usize, AbiShape::FeedbackCellPtr];
...
const P_OBJ_OBJ_FEEDBACK: &[AbiShape] =
	&[AbiShape::PyObjectPtr, AbiShape::PyObjectPtr, AbiShape::FeedbackCellPtr];
const P_OBJ_OBJ_OBJ: &[AbiShape] =
	&[AbiShape::PyObjectPtr, AbiShape::PyObjectPtr, AbiShape::PyObjectPtr];
const P_OP_OBJ: &[AbiShape] = &[AbiShape::U8, AbiShape::PyObjectPtr, AbiShape::FeedbackCellPtr];
const P_OP_OBJ_OBJ: &[AbiShape] =
	&[AbiShape::U8, AbiShape::PyObjectPtr, AbiShape::PyObjectPtr, AbiShape::FeedbackCellPtr];
...
const P_OBJ_NAME_FEEDBACK: &[AbiShape] =
	&[AbiShape::PyObjectPtr, AbiShape::U32, AbiShape::FeedbackCellPtr];
...
const P_CALL_FEEDBACK: &[AbiShape] =
	&[AbiShape::PyObjectPtr, AbiShape::PyObjectPtrPtr, AbiShape::Usize, AbiShape::FeedbackCellPtr];
...
const P_FUNCTION_SET_CLOSURE: &[AbiShape] =
	&[AbiShape::PyObjectPtr, AbiShape::PyObjectPtrPtr, AbiShape::Usize];
...
const P_IMPORT_NAME: &[AbiShape] =
	&[AbiShape::U32, AbiShape::ConstNamePtr, AbiShape::Usize, AbiShape::U32];
const P_MATCH_CLASS: &[AbiShape] = &[
	AbiShape::PyObjectPtr,
	AbiShape::PyObjectPtr,
	AbiShape::Usize,
	AbiShape::ConstNamePtr,
...
pub static PHASE_B_HELPERS: &[HelperSig] = &[
	HelperSig {
		id:                HelperId::ConstInt,
		family:            HelperFamily::Number,
		symbol:            "pon_const_int",
		params:            P_I64,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::ConstFloat,
		family:            HelperFamily::Number,
	...
	HelperSig {
		id:                HelperId::ConstComplex,
		family:            HelperFamily::Number,
		symbol:            "pon_const_complex",
		params:            &[AbiShape::F64, AbiShape::F64],
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::ConstBool,
		family:            HelperFamily::Number,
	...
	HelperSig {
		id:                HelperId::Contains,
		family:            HelperFamily::Seq,
		symbol:            "pon_contains",
		params:            P_OBJ_OBJ,
		ret:               AbiShape::I32,
		feedback_trailing: 0,
	...
	HelperSig {
		id:                HelperId::ConstStr,
		family:            HelperFamily::Str,
	...
	HelperSig {
		id:                HelperId::BuildSlice,
		family:            HelperFamily::Seq,
		symbol:            "pon_build_slice",
		params:            P_OBJ_OBJ_OBJ,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::ListAppend,
		family:            HelperFamily::Seq,
	...
	HelperSig {
		id:                HelperId::UnpackSeq,
		family:            HelperFamily::Seq,
		symbol:            "pon_unpack_seq",
		params:            P_OBJ_ARR_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		...
		family:            HelperFamily::Seq,
		symbol:            "pon_get_len",
		params:            P_OBJ_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		id:                HelperId::BuildMap,
	...
	HelperSig {
		id:                HelperId::SubscriptGet,
		family:            HelperFamily::Map,
		symbol:            "pon_subscript_get",
		params:            P_OBJ_OBJ_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		id:                HelperId::SubscriptSet,
		family:            HelperFamily::Map,
	...
	HelperSig {
		id:                HelperId::LoadGlobal,
		family:            HelperFamily::ImportBuiltins,
		symbol:            "pon_load_global",
		params:            P_NAME_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		id:                HelperId::StoreGlobal,
		family:            HelperFamily::ImportBuiltins,
	...
	HelperSig {
		id:                HelperId::LoadAttr,
		family:            HelperFamily::ObjectAttr,
		symbol:            "pon_load_attr",
		params:            P_OBJ_NAME_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		id:                HelperId::StoreAttr,
		family:            HelperFamily::ObjectAttr,
		symbol:            "pon_store_attr",
		params:            P_OBJ_NAME_OBJ,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::DeleteAttr,
		family:            HelperFamily::ObjectAttr,
	...
	HelperSig {
		id:                HelperId::BoolTest,
		family:            HelperFamily::ObjectAttr,
		symbol:            "pon_bool_test",
		params:            P_OBJ_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	...
	HelperSig {
		id:                HelperId::CallMethod,
		family:            HelperFamily::Call,
		symbol:            "pon_call_method",
		params:            P_CALL_FEEDBACK,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 1,
	},
	HelperSig {
		id:                HelperId::MakeFunction,
		family:            HelperFamily::Call,
		symbol:            "pon_make_function",
		params:            P_MAKE_FUNCTION,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::MakeFunctionFull,
		family:            HelperFamily::Call,
		symbol:            "pon_make_function_full",
		params:            P_MAKE_FUNCTION_FULL,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::BuildClass,
		family:            HelperFamily::Call,
		symbol:            "pon_build_class_ex",
		params:            P_BUILD_CLASS,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::Raise,
		family:            HelperFamily::Exc,
		symbol:            "pon_raise",
		params:            P_RAISE,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	...
	HelperSig {
		id:                HelperId::FunctionSetClosure,
		family:            HelperFamily::Call,
		symbol:            "pon_function_set_closure",
		params:            P_FUNCTION_SET_CLOSURE,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::MakeCell,
		family:            HelperFamily::Call,
	...
	HelperSig {
		id:                HelperId::CurrentClosureCell,
		family:            HelperFamily::Call,
	...
	HelperSig {
		id:                HelperId::ImportName,
		family:            HelperFamily::ImportBuiltins,
		symbol:            "pon_import_name",
		params:            P_IMPORT_NAME,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::ImportFrom,
		family:            HelperFamily::ImportBuiltins,
	...
	HelperSig {
		id:                HelperId::MatchSequence,
		family:            HelperFamily::Match,
	...
	HelperSig {
		id:                HelperId::MatchClass,
		family:            HelperFamily::Match,
		symbol:            "pon_match_class",
		params:            P_MATCH_CLASS,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
	HelperSig {
		id:                HelperId::MatchKeys,
		family:            HelperFamily::Match,
	...
	HelperSig {
		id:                HelperId::FunctionSetAnnotate,
		family:            HelperFamily::Call,
	...
	HelperSig {
		id:                HelperId::BuildClassFull,
		family:            HelperFamily::Call,
		symbol:            "pon_build_class_full",
		params:            P_BUILD_CLASS_FULL,
		ret:               AbiShape::PyObjectPtr,
		feedback_trailing: 0,
	},
];
...
///
/// Signatures are built from [`pon_runtime::abi::HELPERS`] and [`AbiTy`].
/// Pointer ABI types use `module.target_config().pointer_type()`, while integer
/// ABI types are represented by same-width Cranelift integer types because CLIF
/// integer values carry width, not signedness. Every import uses a
/// runtime-exported `symbol` string and [`Linkage::Import`].
...
fn helper_signature<M: Module>(module: &M, params: &[AbiTy], ret: AbiTy) -> ir::Signature {
	...
	sig.params.extend(
		params
			.iter()
			.copied()
			.map(|ty| AbiParam::new(abi_type(module, ty))),
	);

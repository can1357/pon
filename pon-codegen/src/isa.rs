...
//! only centralizes the shared flags that every codegen frontend must use so
//! the JIT and AOT paths agree on stack walking, PIC mode, and libcall
//! relocation behavior.
...
mod tests {
	...
	use super::{OptLevel, make_shared_flags};

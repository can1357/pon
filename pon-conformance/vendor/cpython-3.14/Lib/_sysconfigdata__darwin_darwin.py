...
build_time_vars = {
    ...
    'BASECPPFLAGS': '',
    'BASEMODLIBS': '',
    'BINDIR': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/bin',
    'BINLIBDEST': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14',
    'BLDLIBRARY': '',
    'BLDSHARED': 'clang -bundle -undefined dynamic_lookup',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.exe',
    'BUILDPYTHON': 'python.exe',
    'BUILD_GNU_TYPE': 'aarch64-apple-darwin25.4.0',
    ...
    'CONFIGURE_CFLAGS': '',
    'CONFIGURE_CFLAGS_NODIST': '-I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability',
    ...
    'CONFIG_ARGS': "'--prefix=/opt/homebrew/opt/python@3.14' '--enable-ipv6' '--datarootdir=/opt/homebrew/opt/python@3.14/share' '--datadir=/opt/homebrew/opt/python@3.14/share' '--without-ensurepip' '--enable-loadable-sqlite-extensions' '--with-openssl=/opt/homebrew/opt/openssl@3' '--enable-optimizations' '--with-system-expat' '--with-system-libmpdec' '--with-readline=editline' '--with-lto' '--enable-framework=/opt/homebrew/opt/python@3.14/Frameworks' '--with-dtrace' '--with-dbmliborder=ndbm' 'MACOSX_DEPLOYMENT_TARGET=26' 'CFLAGS_NODIST=-I/opt/homebrew/include' 'LDFLAGS_NODIST=-L/opt/homebrew/lib -Wl,-rpath,/opt/homebrew/lib' 'CPPFLAGS=-I/opt/homebrew/include' 'py_cv_module__tkinter=n/a' 'PKG_CONFIG_PATH=/opt/homebrew/opt/pkgconf/lib/pkgconfig:/opt/homebrew/opt/mpdecimal/lib/pkgconfig:/opt/homebrew/opt/openssl@3/lib/pkgconfig:/opt/homebrew/opt/readline/lib/pkgconfig:/opt/homebrew/opt/sqlite/lib/pkgconfig:/opt/homebrew/opt/xz/lib/pkgconfig:/opt/homebrew/opt/lz4/lib/pkgconfig:/opt/homebrew/opt/zstd/lib/pkgconfig' 'PKG_CONFIG_LIBDIR=/usr/lib/pkgconfig:/opt/homebrew/Library/Homebrew/os/mac/pkgconfig/26' 'CC=clang'",
    'CONFINCLUDEDIR': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include',
    'CONFINCLUDEPY': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/lcov-report',
    ...
    'DESTLIB': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14',
    'DESTPATH': '',
    'DESTSHARED': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '',
    'EXEMODE': 755,
    'EXENAME': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/bin/python3.14',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    ...
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '',
    'HOST_GNU_TYPE': 'aarch64-apple-darwin25.4.0',
    'INCLDIRSTOMAKE': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include /opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include /opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include/python3.14 /opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include/python3.14',
    'INCLUDEDIR': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include',
    'INCLUDEPY': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/include/python3.14',
    ...
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14',
    'LIBDIR': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/pkgconfig',
    'LIBPL': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14/config-3.14-darwin',
    'LIBPYTHON': '',
    ...
    'LIBSUBDIRS': 'asyncio \\',
    'LINKCC': 'clang',
    'LINKFORSHARED': '-Wl,-stack_size,1000000  -framework CoreFoundation /opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/Python',
    ...
    'MACHDEP': 'darwin',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14/lib/python3.14',
    'MACOSX_DEPLOYMENT_TARGET': '26',
    'MAJOR_IN_MKDEV': 0,
    'MAJOR_IN_SYSMACROS': 0,
    'MAKESETUP': './Modules/makesetup',
    'MANDIR': '/opt/homebrew/opt/python@3.14/share/man',
    'MIMALLOC_HEADERS': '\\',
    'MKDIR_P': 'mkdir -p',
    ...
    'MODULE_READLINE_CFLAGS': '-I/Library/Developer/CommandLineTools/SDKs/MacOSX26.sdk/usr/include/editline',
    ...
    'MODULE__CTYPES_TEST_CFLAGS': '-I/Library/Developer/CommandLineTools/SDKs/MacOSX26.sdk/usr/include/ffi -DUSING_APPLE_OS_LIBFFI=1 -DUSING_MALLOC_CLOSURE_DOT_C=1',
    ...
    'PYTHONFRAMEWORKINSTALLDIR': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework',
    'PYTHONFRAMEWORKINSTALLNAMEPREFIX': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14',
    'PYTHONFRAMEWORKPREFIX': '/opt/homebrew/opt/python@3.14/Frameworks',
    'PYTHONPATH': '',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall',
    'PY_CFLAGS_NODIST': '-I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/code.profclangd -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -fno-common -dynamic -DNDEBUG -g -O3 -Wall -I/opt/homebrew/include -flto=thin -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Werror=unguarded-availability -fprofile-instr-use=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6/code.profclangd -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -I/opt/homebrew/include -DPy_BUILD_CORE',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6 ./python.exe -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'DYLD_FRAMEWORK_PATH=/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6 ./python.exe -E -m test',
    ...
    'abs_builddir': '/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6',
    'abs_srcdir': '/private/tmp/pythonA3.14-20260610-7733-axt9ql/Python-3.14.6',
    'datarootdir': '/opt/homebrew/opt/python@3.14/share',
    'exec_prefix': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14',
    'host_exec_prefix': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14',
    'host_prefix': '/opt/homebrew/opt/python@3.14/Frameworks/Python.framework/Versions/3.14',

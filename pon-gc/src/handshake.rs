...
impl GcHandshake {
    ...
    pub fn request_stop(&self) {
        #[cfg(feature = "free-threading")]
        {
            ...
            self.phase.store(GcPhase::StopRequested as u8, Ordering::Release);
        }
    }
...
///
/// Default builds intentionally leave both the handshake and query surface inert.
...
///
/// Default builds always return `false`, preserving the Phase-A/D invariant that
/// GC never asks another runtime thread to stop.
#[must_use]

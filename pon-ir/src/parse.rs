...
//!
//! This module is the only place in `pon-ir` that invokes Ruff's parser. It pins
//! parsing to Python 3.14 so the frontend never accidentally falls back to Ruff's
//! older default target version.

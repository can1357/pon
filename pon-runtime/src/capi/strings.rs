...
pub(crate) struct PyPonCapiStrings {
	...
	unicode_replace:
		unsafe extern "C" fn(*mut PyObject, *mut PyObject, *mut PyObject, PySsizeT) -> *mut PyObject,
	unicode_tailmatch:
	...
	unicode_decode:
		unsafe extern "C" fn(*const c_char, PySsizeT, *const c_char, *const c_char) -> *mut PyObject,
	unicode_resize: unsafe extern "C" fn(*mut *mut PyObject, PySsizeT) -> c_int,
	unicode_copy_characters:
		unsafe extern "C" fn(*mut PyObject, PySsizeT, *mut PyObject, PySsizeT, PySsizeT) -> PySsizeT,
}

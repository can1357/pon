//! `_asyncio` compatibility backed by the vendored pure-Python asyncio implementation.
//!
...
//! the stdlib fallbacks bind), then re-exports those fallback objects for direct
//! `_asyncio` imports.

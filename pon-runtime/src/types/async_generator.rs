...
use crate::object::{GetAttrFunc, PyAsyncMethods, PyObject, PyObjectHeader, PyType};
use crate::types::generator::{PyGenerator, bound_generator_method, exact_args};
...
/// GC type id reserved for wrapped async-yield marker boxes in the WS-GEN family.
...
static ASYNC_GENERATOR_ASYNC_METHODS: LazyLock<Mutex<Option<usize>>> = LazyLock::new(|| Mutex::new(None));
...
pub fn ensure_async_generator_type(type_type: *mut PyType) -> *mut PyType {
    let mut slot = ASYNC_GENERATOR_TYPE.lock().unwrap_or_else(|poison| poison.into_inner());
    if let Some(ptr) = *slot {
        return ptr as *mut PyType;
    }

    let async_methods = ensure_async_generator_async_methods();
    let mut ty = PyType::new(type_type.cast_const(), "async_generator", mem::size_of::<PyAsyncGenerator>());
...
fn ensure_async_generator_async_methods() -> *mut PyAsyncMethods {
    let mut slot = ASYNC_GENERATOR_ASYNC_METHODS.lock().unwrap_or_else(|poison| poison.into_inner());
    if let Some(ptr) = *slot {
...
fn ensure_awaitable_type(type_type: *mut PyType, slot: &Mutex<Option<usize>>, name: &'static str) -> *mut PyType {
...
fn ensure_awaitable_async_methods() -> *mut PyAsyncMethods {
    let mut slot = AWAITABLE_ASYNC_METHODS.lock().unwrap_or_else(|poison| poison.into_inner());
    if let Some(ptr) = *slot {
        return ptr as *mut PyAsyncMethods;
    }
    let mut methods = PyAsyncMethods::EMPTY;
...
pub fn ensure_wrapped_value_type(type_type: *mut PyType) -> *mut PyType {
    let mut slot = WRAPPED_VALUE_TYPE.lock().unwrap_or_else(|poison| poison.into_inner());
    if let Some(ptr) = *slot {
        return ptr as *mut PyType;
    }
    let mut ty = PyType::new(type_type.cast_const(), "async_generator_wrapped_value", mem::size_of::<PyAsyncGenWrappedValue>());
...
pub unsafe extern "C" fn async_generator_anext(object: *mut PyObject) -> *mut PyObject {
    ...
    unsafe { crate::abi::r#gen::async_gen_make_awaitable(object, core::ptr::null_mut(), AWAITABLE_MODE_SEND) }
}
...
pub unsafe extern "C" fn awaitable_next(object: *mut PyObject) -> *mut PyObject {
    ...
    unsafe { crate::abi::r#gen::async_gen_awaitable_step(object, core::ptr::null_mut(), core::ptr::null_mut()) }
}
...
pub unsafe extern "C" fn trace_async_gen_awaitable(object: *mut u8, visitor: &mut dyn FnMut(*mut u8)) {
    if object.is_null() {
        return;
    }
...
pub unsafe extern "C" fn trace_async_gen_wrapped(object: *mut u8, visitor: &mut dyn FnMut(*mut u8)) {
    if object.is_null() {
        return;
    }
...
unsafe extern "C" fn asyncgen_anext_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
    ...
    unsafe { crate::abi::r#gen::async_gen_make_awaitable(args[0], core::ptr::null_mut(), AWAITABLE_MODE_SEND) }
}
...
unsafe extern "C" fn asyncgen_athrow_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
...
unsafe extern "C" fn asyncgen_aclose_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
    let args = match unsafe { exact_args(argv, argc, 1, "aclose") } {
        Ok(args) => args,
        Err(message) => return crate::abi::return_null_with_error(message),
    };
    // SAFETY: The bound method receiver is the only exact slot.
    unsafe { crate::abi::r#gen::async_gen_make_awaitable(args[0], core::ptr::null_mut(), AWAITABLE_MODE_CLOSE) }
}
...
/// runtime string.
pub unsafe extern "C" fn async_generator_getattro(object: *mut PyObject, name: *mut PyObject) -> *mut PyObject {
    ...
    match name {
        "__aiter__" => unsafe { bound_generator_method(object, "__aiter__", 1, asyncgen_aiter_method as *const u8) },
        "__anext__" => unsafe { bound_generator_method(object, "__anext__", 1, asyncgen_anext_method as *const u8) },
        "asend" => unsafe { bound_generator_method(object, "asend", 2, asyncgen_asend_method as *const u8) },
        "athrow" => unsafe { bound_generator_method(object, "athrow", 2, asyncgen_athrow_method as *const u8) },
        "aclose" => unsafe { bound_generator_method(object, "aclose", 1, asyncgen_aclose_method as *const u8) },
...
unsafe extern "C" fn awaitable_throw_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
...
unsafe extern "C" fn awaitable_close_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
...
unsafe extern "C" fn awaitable_next_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
    ...
    // SAFETY: The bound method receiver is the only exact slot.
    unsafe { crate::abi::r#gen::async_gen_awaitable_step(args[0], core::ptr::null_mut(), core::ptr::null_mut()) }
}

unsafe extern "C" fn awaitable_identity_method(argv: *mut *mut PyObject, argc: usize) -> *mut PyObject {
...
/// runtime string.
pub unsafe extern "C" fn awaitable_getattro(object: *mut PyObject, name: *mut PyObject) -> *mut PyObject {
    let Some(name) = (unsafe { type_::unicode_text(name) }) else {
        return crate::abi::return_null_with_error("awaitable attribute name must be str");
    };
    match name {
        "send" => unsafe { bound_generator_method(object, "send", 2, awaitable_send_method as *const u8) },
        "throw" => unsafe { bound_generator_method(object, "throw", 2, awaitable_throw_method as *const u8) },
        "close" => unsafe { bound_generator_method(object, "close", 1, awaitable_close_method as *const u8) },
        "__next__" => unsafe { bound_generator_method(object, "__next__", 1, awaitable_next_method as *const u8) },
        "__iter__" | "__await__" => unsafe { bound_generator_method(object, "__iter__", 1, awaitable_identity_method as *const u8) },
        _ => crate::abi::return_null_with_error(format!("attribute '{name}' was not found")),
    }
}
